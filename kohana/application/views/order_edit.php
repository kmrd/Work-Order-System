	...
	<div class="form-group <? echo (isset($errors['servicedate'])) ? 'has-error' : ''; ?>">
		...
		<div class="col-sm-6">
			<div class="input-group datepicker input-append date" id="datetimepicker1">
				<input data-format="MM/dd/yyyy" type="text" name='servicedate' class="form-control" placeholder='mm/dd/yyyy' data-default-start-date="<? echo date('m/d/Y', strtotime($data['servicedate'])); ?>">
